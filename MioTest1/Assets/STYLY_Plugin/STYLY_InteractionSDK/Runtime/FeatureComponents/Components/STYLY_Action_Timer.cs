...
namespace STYLY.Interaction.SDK.V1
{
    ...
    public class STYLY_Action_Timer : FeatureComponentBase, ITimer
    {
        ...
        [SerializeField,Tooltip("Sec")][HideInInspector]
        float time = 0f; // タイマー時間

        [SerializeField, FormerlySerializedAs("min_time"),Tooltip("Sec")][HideInInspector]
        float minTime = 0f; // 最小タイマー時間

        [SerializeField, FormerlySerializedAs("max_time"),Tooltip("Sec")][HideInInspector]
